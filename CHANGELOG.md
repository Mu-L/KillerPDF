...
- Added reusable axial and radial gradient shadings with clipping, arbitrary strictly ordered Gray, RGB, or CMYK color stops, two-color interpolation, multi-stop stitching functions, extension controls, consistent color-space validation, and deterministic sharing across pages.
