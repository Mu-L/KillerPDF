...
- Added editable PDF 2.0 text notes with all seven standard icon names, highlights, underlines, strikeouts, squiggles, left-, center-, or right-aligned multiline free-text boxes, solid or dashed lines and polylines with all ten standard PDF line-ending styles and optional interior colors, solid or dashed polygons, rectangles and ellipses, solid or dashed multi-stroke ink, and image stamps with Unicode contents, optional author, subject, creation and modification metadata, typed print and interaction flags, and deterministic appearances.
