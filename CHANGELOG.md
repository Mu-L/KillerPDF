...
- Added bounded Gray, RGB, and CMYK ICC profile loading plus PDF/A-4 and PDF/A-4f authoring with required metadata, output intents, identification schemas, and associated embedded files.
